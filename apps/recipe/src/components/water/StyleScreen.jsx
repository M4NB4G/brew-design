// StyleScreen.jsx
// "Style": the BJCP 2021 style family and its target water profile, Brew
// Water Chem's StyleTab in its wording. The families are the engine's
// (STYLE_FAMILIES); the chosen one and its targets come from computeWater.
// Picking another returns the brewer's own salt and acid amounts to the
// recommendation (water-state.js).
import { STYLE_FAMILIES } from '@brew/engine';
import Card from '../shared/Card.jsx';
import { colors, tokens } from '../shared/styles.js';
import { setWaterStyle } from '../../water-state.js';
...
export default function StyleScreen({ styleId, figures, setWater }) {
  const { style, target } = figures;
  return (
    <>
      <Card>
