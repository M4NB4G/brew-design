        ...
        <div style={{ fontSize: '0.92rem', lineHeight: 1.6, color: colors.textPrimary }}>
          ...
          <ul style={{ marginLeft: '1.2rem', lineHeight: 1.7 }}>
            ...
            <li>
              ...
              etc.) — opt-in via the "Use multiple acids" checkbox on the Salts
              &amp; Acid screen. mEq combines linearly across acids with no cross-terms.
            </li>
          ...
          <p>
            ...
            secondary acids are user-entered. Choosing the solver&apos;s own acid is
            not yet planned in Brew Design; picking another acid in the Acid Dose
            card shows the same dose in that acid.
          </p>
          <p>
            The multi-acid card, the per-row mEq contribution hint, and the
            &ldquo;Total acid: X mEq → −Y ppm Alk&rdquo; summary are all here. The
            chemistry engine (constants, capacity formulas, alkalinity-reduction
            math) is Brew Water Chem&apos;s, unchanged — reference-batch parity vs
            Bru&apos;n Water 1.25 free is preserved exactly.
          </p>
        </div>
      </Card>
      ...
      <Card>
        ...
        <ol style={{ fontSize: '0.85rem', lineHeight: 1.65, color: colors.textPrimary, paddingLeft: '1.4rem', margin: 0 }}>
          <li style={{ marginBottom: '0.85rem' }}>
            ...
            <span style={{ color: colors.textSecondary, overflowWrap: 'anywhere' }}>https://www.bjcp.org/style/2021/</span>
            <br />
