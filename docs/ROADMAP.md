...
| Design warnings | Mash Rv outside 1.25–2 qt/lb and mash R outside 2.5–4 lb/lb warn beside their values (the owner's Recipe Designer, Grist and Pitch Calc's F3 and F4); a post-boil volume below the fermentation volume warns on the Volumes card. Warnings change no number. The limits are spreadsheet constants, so Tier A + B. Scope table put to the owner 2026-09-23, not yet agreed | suites + inspector + far end |
